                ...
                <div>
                    <div className="slider-card-list">
                        <button className="productivity-card">
                            <h3>Boards</h3>
                            <p>Trilili boards keep tasks organized and work moving forward. In a glance,
                                see everything from “things to do” to “aww yeah, we did it!”</p>
                        </button>

                        <button className="productivity-card">
                            <h3>Lists</h3>
                            <p>The different stages of a task. Start as simple as To Do, Doing or Done—or build a workflow custom fit to your team’s needs. There’s no wrong way to Trilili.</p>
                        </button>
